...
const Dashboard = () => {
  ...
  if (!isAuthenticated()) {
    console.log(
      "Trying to access dashboard without authentication. Redirecting to signin page."
    );
                    ...
                    <button
                      onClick={() =>
                        navigator.clipboard.writeText(
                          `https://${project.projectSlug}.localhost:8000`
                        )
                      }
