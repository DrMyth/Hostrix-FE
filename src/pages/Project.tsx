  ...
  const projectTypes = [
    {
      ...
      features: ["Global CDN", "Instant cache invalidation", "Automatic SSL"],
    },
    {
      ...
      features: ["Auto-scaling", "Background jobs", "High availability"],
    },
    {
      id: "fullstack-app",
      title: "Fullstack App",
              ...
              <div className="space-y-2">
                ...
                {projectSlug && (
                  <p className="text-sm text-muted-foreground">
                    Preview: https://{projectSlug}.hostrix.app
                  </p>
                )}
              </div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  {projectTypes.map((type) => (
                    <button
                      ...
                      className={`text-left rounded-lg border p-4 hover:border-primary/30 transition-all ${
                        projectType === type.id
